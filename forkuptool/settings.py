"""
Django settings for forkuptool project.
...
SECRET_KEY = '8)d8!#4=nhmaos4h)+n2iwho(9e#_^=up06n3w-%a4!cggkl^1'
...
WSGI_APPLICATION = 'forkuptool.wsgi.application'
