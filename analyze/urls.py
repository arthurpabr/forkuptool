...
urlpatterns = [
    ...
    url(r'^simular_conflitos_xls/(?P<configuracaoferramenta_escolhida>\d+)/(?P<nome_branch_origem>\w+)/(?P<nome_branch_forkeado>\w+)/$', views.simular_conflitos_xls, name='simular_conflitos_xls'),
